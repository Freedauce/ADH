...
export default function PageHeader({ label, title, subtitle }) {
    return (
        <section className="relative pt-16 pb-16 md:pt-20 md:pb-20 overflow-hidden">
            {/* Background Effects */}
            <div className="absolute inset-0 bg-gradient-to-b from-adhi-dark via-black to-black" />
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                ...
                >
                    ...
                    {subtitle && (
                        <p className="text-lg md:text-xl text-adhi-gray-400 max-w-2xl leading-relaxed">
                            {subtitle}
                        </p>
                    )}
                </motion.div>
